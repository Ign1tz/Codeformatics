...
public class Vars {
    ...
    public static String pathScoreboard = "src/main/resources/com/example/codeformaticsfx/GameResources/Scoreboards/javaScoreboard.json";
    public static String pathQuestions = "src/main/resources/com/example/codeformaticsfx/GameResources/QuestionLibrary/java.json";
